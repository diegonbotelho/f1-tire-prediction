...
def get_data():
    # Gets the data and returns as a Pandas Dataframe.
...
def clean_data(data):
    ...
    drop_columns = [
    'Time', 'DriverNumber', 'PitOutTime', 'PitInTime', 'Sector1SessionTime', 'Sector2SessionTime',
    'Sector3SessionTime', 'SpeedI1', 'SpeedI2', 'SpeedFL', 'SpeedST', 'IsPersonalBest', 'FreshTyre', 'Team',
    'LapStartTime', 'LapStartDate', 'TrackStatus', 'Deleted', 'DeletedReason', 'FastF1Generated',
    'IsAccurate', 'WindDirection', 'WindSpeed', 'Delta_Lap'
]
...
def load_model():
    ...
    # Now, join paths in a platform-independent way:
    model_path = project_root / "raw_data" / "pipeline_model.pkl"
...
# fazer o input das features necessárias (as que queremos ter no front)
# fazer as funções de pre-processamento
